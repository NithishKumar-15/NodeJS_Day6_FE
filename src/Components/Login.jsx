...
export const Login = () => {
  ...
  async function verifyLogin(e){
    ...
    await axios.post("https://nodejs-day6-be.onrender.com/authenticate",data).then(async(res)=>{
      const token={
        token:res.data.token
      }
      //api to verify the token
      await axios.post("https://nodejs-day6-be.onrender.com/authenticate/verifytoken",token).then((restoken)=>{
